...
func booksLanding(w http.ResponseWriter, r *http.Request) {
	...
	t, _ := template.ParseFiles("ui/html/welcome.html")
	t.Execute(w, nil)
}

func booksError(w http.ResponseWriter, r *http.Request) {

	t, _ := template.ParseFiles("ui/html/error.html")
	t.Execute(w, nil)
}
...
func bookIndex(w http.ResponseWriter, r *http.Request) {
	...
	t, _ := template.ParseFiles("ui/html/index.html", "ui/html/base.html")
...
func bookShow(w http.ResponseWriter, r *http.Request) {
	...
	// render html template
	t, _ := template.ParseFiles("ui/html/book.html", "ui/html/base.html")
...
func create_book(w http.ResponseWriter, r *http.Request) {
	if r.Method == "GET" {
		t, _ := template.ParseFiles("ui/html/new_book.html", "ui/html/base.html")
		t.Execute(w, nil)
	} else {
		r.ParseForm()
